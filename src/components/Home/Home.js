  ...
  return(
    <React.Fragment>
      ...
      <header className="container center-align">
        <div>
          <img src="/notga/icons/dbk/drabkirn-logo-192x192.png" alt="drabkirn logo" className="responsive-img" />
        </div>
        <div>
          <h1>Notga</h1>
        </div>
      ...
      <section className="container mt-5rem" id="tour">
        <div className="row flex-center-vh">
          <div className="col m6 s12">
            <img src="/notga/images/illustrations/privacy.svg" alt="privacy illustration" className="responsive-img" />
          </div>
      ...
      <section className="container mt-5rem" id="how-it-works">
        <div className="row flex-center-vh hide-on-small-only">
          ...
          <div className="col m6 s12">
            <img src="/notga/images/illustrations/factory.svg" alt="how it works illustration" className="responsive-img" />
          </div>
        </div>
      ...
      <section className="container mt-5rem" id="storage">
        <div className="row flex-center-vh">
          <div className="col m6 s12">
            <img src="/notga/images/illustrations/storage.svg" alt="storage illustration" className="responsive-img" />
          </div>
      ...
      <section className="container mt-5rem">
        <div className="row flex-center-vh hide-on-small-only">
          ...
          <div className="col m6 s12">
            <img src="/notga/images/illustrations/notebook.svg" alt="notebook illustration" className="responsive-img" />
          </div>
        </div>
      ...
      <section className="container mt-5rem">
        <div className="row flex-center-vh">
          <div className="col m6 s12">
            <img src="/notga/images/illustrations/lockin.svg" alt="lockin illustration" className="responsive-img" />
          </div>
      ...
      <section className="container mt-5rem">
        <div className="row flex-center-vh hide-on-small-only">
          ...
          <div className="col m6 s12">
            <img src="/notga/images/illustrations/set-it-free.svg" alt="set-it-free illustration" className="responsive-img" />
          </div>
        </div>
